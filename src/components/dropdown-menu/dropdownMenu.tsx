...
interface DropdownRootProps
  extends React.ComponentProps<typeof DropdownMenu.Root> {
  children?: ReactNode;
}
...
interface DropdownTriggerProps
  extends React.ComponentProps<typeof DropdownMenu.Trigger> {
  children?: ReactNode;
}
...
interface DropdownPortalProps
  extends React.ComponentProps<typeof DropdownMenu.Portal> {
  children?: ReactNode;
}
...
const DropDownContent = ({ children, ...rest }: DropdownContentProps) => {
  return <DropdownMenu.Content {...rest}>{children}</DropdownMenu.Content>;
};
...
interface DropdownArrowProps
  extends React.ComponentProps<typeof DropdownMenu.Arrow> {}

const DropDownArrow = ({ ...rest }: DropdownArrowProps) => {
  return <DropdownMenu.Arrow {...rest} />;
};
...
interface DropdownGroupProps
  extends React.ComponentProps<typeof DropdownMenu.Group> {
  children: ReactNode;
}

const DropDownGroup = ({ children, ...rest }: DropdownGroupProps) => {
  return <DropdownMenu.Group {...rest}>{children}</DropdownMenu.Group>;
};
...
const DropDownLabel = ({ children, ...rest }: DropdownLabelProps) => {
  return <DropdownMenu.Label {...rest}>{children}</DropdownMenu.Label>;
};
...
const DropDownCheckBoxItem = ({
  ...
  return (
    <DropdownMenu.CheckboxItem {...rest}>{children}</DropdownMenu.CheckboxItem>
  );
};
...
interface DropdownRadioGroupProps
  extends React.ComponentProps<typeof DropdownMenu.RadioGroup> {
  children: ReactNode;
}

const DropDownRadioGroup = ({ children, ...rest }: DropdownRadioGroupProps) => {
  return (
    <DropdownMenu.RadioGroup {...rest}>{children}</DropdownMenu.RadioGroup>
  );
};
...
interface DropdownRadioItemProps
  extends React.ComponentProps<typeof DropdownMenu.RadioItem> {
  children: ReactNode;
}

const DropDownRadioItem = ({ children, ...rest }: DropdownRadioItemProps) => {
  return <DropdownMenu.RadioItem {...rest}>{children}</DropdownMenu.RadioItem>;
};
...
interface DropdownItemIndicatorProps
  extends React.ComponentProps<typeof DropdownMenu.ItemIndicator> {}

const DropDownItemIndicator = ({ ...rest }: DropdownItemIndicatorProps) => {
  return <DropdownMenu.ItemIndicator {...rest} />;
};
...
const DropDownSeparator = ({ ...rest }: DropdownSeparatorProps) => {
  return <DropdownMenu.Separator {...rest} />;
};
...
const DropDownSub = ({ children, ...rest }: DropdownSub) => {
  return <DropdownMenu.Sub {...rest}>{children}</DropdownMenu.Sub>;
};
...
const DropDownSubTrigger = ({ children, ...rest }: DropdownSubTrigger) => {
  return (
    <DropdownMenu.SubTrigger {...rest}>{children}</DropdownMenu.SubTrigger>
  );
};
...
const DropDownSubContent = ({ children, ...rest }: DropdownSubContent) => {
  return (
    <DropdownMenu.SubContent {...rest}>{children}</DropdownMenu.SubContent>
  );
};
